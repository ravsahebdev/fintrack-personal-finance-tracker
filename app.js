...
function renderCards() {
    ...
    document.getElementById('cardBalance').textContent = formatAmount(totals.balance);
    document.getElementById('cardIncome').textContent = formatAmount(totals.income);
    document.getElementById('cardExpense').textContent = formatAmount(totals.expense);
